...
CREATE TABLE Ano(
	...
	CONSTRAINT ck_ano CHECK (ano between 1886 and YEAR(GETDATE())) -- O ano de 1886 e considerado como o ano de nascimento do carro moderno, verificar se ano menor que 1886 e maior que o atual
);
...
CREATE TABLE Mes(
	...
	CONSTRAINT ck_mes CHECK (mes between 01 and 12), -- Verificar se os meses o de 01 a 12
